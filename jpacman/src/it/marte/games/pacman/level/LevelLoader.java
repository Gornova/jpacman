...
public class LevelLoader {
	 ...
	 * 
	 * @throws FileNotFoundException - if file is not found at file path specified
	 * @throws IOException - if there are some IO errors
	 */
	public LevelLoader(String filePath) throws FileNotFoundException, IOException {
		...
		for (Object iterable_element : prop.keySet()) {
			table.put((String)iterable_element, prop.getProperty((String)iterable_element));
		}
	}

	/**
	 * Load Hashtable of level definitions. Key is level number,Value is level's map name 
	 */
