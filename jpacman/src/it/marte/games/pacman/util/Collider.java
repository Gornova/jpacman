...
public class Collider {
     ...
     * @param subject
     * @param obstacle
     * @return true if subject collide with obstacle
     */
     ...
     * @param subject
     * @param obstacles
     * @return the first obstacle, null otherwise
     */
    public static Body testAndReturn(Body subject, Iterable<Body> obstacles) {
	for (Body obstacle : obstacles) {
	    if (!subject.equals(obstacle) && intersecting(subject, obstacle)) {
    ...
    public static ArrayList<Body> testAndReturnBodies(Body subject,
	    Iterable<Body> obstacles) {
